...
public class PSQuoteListingPage extends FrameworkMethods {
	
	Logger logger = Logger.getLogger(PSQuoteListingPage.class);
	...
	public void C462906_Regression_PS_Quotes_VerifySearchResultsWithDifferentSubOptionsForQuoteCreatedOnDateRangeInQuoteListingPage_CSR() {

		initializeReporting("Verify search results with different sub options for 'Quote Created On' date range in quote listing page","C462906_Regression_PS_Quotes_VerifySearchResultsWithDifferentSubOptionsForQuoteCreatedOnDateRangeInQuoteListingPage_CSR",logger);
	 ...
	 /**
	 * Quote_Verify search results for 'Quote Number' in quote listing page
	 * @TestCaseLink https://hpitdce.testrail.net/index.php?/cases/view/462903
	 * @since Mar 18, 2022
	 * @author RamanatM
	 */
	@Test(groups = { IGroupsTagging.ITestType.REGRESSION, IGroupsTagging.IStoreType.PS, IGroupsTagging.IUserType.CSR,
			IGroupsTagging.IModuleType.QUOTES }, priority = 2)
	public void C462903_Regression_PS_Quote_VerifySearchResultsForQuoteNumberInQuoteListingPage_CSR() {

		// Reporting info
		initializeReporting("Verify search results for 'Quote Number' in quote listing page","C462903_Regression_PS_Quote_VerifySearchResultsForQuoteNumberInQuoteListingPage_CSR", logger);
		...
		Assert.assertTrue( quoteDetails.clickOnShareLinkAndEnterEmailIdAndClickOnShareQuoteButtonPS("Precondition: Share quote with another user","Quote Should be shared successfully",purchaser2,true));
	 ...
	 * @TestCaseLink https://hpitdce.testrail.net/index.php?/cases/view/462904
	 * @since March 22, 2022
	 * @author RamanatM
	 */
	@Test(groups = { IGroupsTagging.ITestType.REGRESSION, IGroupsTagging.IStoreType.PS, IGroupsTagging.IUserType.DIRECT,
			IGroupsTagging.IModuleType.QUOTES }, priority = 2)
	public void C462904_Regression_PS_Quotes_VerifySearchResultsForQuoteNameInQuoteListingPage_Direct() {

		//Reporting info
		initializeReporting("Quote_Verify search results for 'Quote Name' in quote listing page",
				"C462904_Regression_PS_Quotes_VerifySearchResultsForQuoteNameInQuoteListingPage_Direct", logger);
